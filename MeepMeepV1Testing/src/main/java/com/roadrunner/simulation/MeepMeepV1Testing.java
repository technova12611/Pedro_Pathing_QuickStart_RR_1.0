...
public class MeepMeepV1Testing {
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myFirstBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(70, 66.0, Math.toRadians(180), Math.toRadians(180), 18)
                .build();
...
//                .strafeToLinearHeading(new Vector2d(30,-11.5), Math.PI)
//                //       .strafeTo(new Vector2d(-50,-12.0))
//                .strafeToLinearHeading(new Vector2d(-56,-12.0), Math.PI)
//                .strafeTo(new Vector2d(30,-12.0))
//                .strafeToLinearHeading(new Vector2d(48.5,-36.0), Math.PI)
...
//                .setReversed(false)
//                .splineToConstantHeading(new Vector2d(29.0, -11.5), Math.toRadians(180.00))
//                .splineToConstantHeading(new Vector2d(-45.5, -11.5), Math.toRadians(180.00))
//                .splineToConstantHeading(new Vector2d(-58.0, -11.5), Math.toRadians(180.00))
//                .setReversed(true)
//                .splineToConstantHeading(new Vector2d(26.00, -11.81), Math.toRadians(0.00))
...
//                .build());
        ...
        myFirstBot.runAction(myFirstBot.getDrive().actionBuilder(new Pose2d(12.0, 63, Math.toRadians(-90)))
                ...
                .setReversed(false)
                .splineToSplineHeading(new Pose2d(20.0, 12, Math.toRadians(180.0)), Math.toRadians(180.00))
//                .splineToConstantHeading(new Vector2d(24.0, 12), Math.toRadians(180.00))
                .splineToConstantHeading(new Vector2d(-36, 12), Math.toRadians(180.00))
                .splineToConstantHeading(new Vector2d(-58.0, 12), Math.toRadians(180.00))
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-36.00, 12), Math.toRadians(0.00))
                .splineToConstantHeading(new Vector2d(24, 12.0), Math.toRadians(0.00))
                .splineToConstantHeading(new Vector2d(45, 33.0), Math.toRadians(0.00))
//                .splineTo(new Vector2d(48, 33.0),Math.toRadians(0.00))
                .setReversed(false)
//                .splineToConstantHeading(new Vector2d(24, 10.0), Math.toRadians(180.00))
...
//                .splineToConstantHeading(new Vector2d(48, 30.0), Math.toRadians(0.00))
                .splineToSplineHeading(new Pose2d(48, 33.0, Math.toRadians(180)),Math.toRadians(0.00))
...
//                .splineToConstantHeading(new Vector2d(24, 10.0), Math.toRadians(180.00))
                ...
                .splineToConstantHeading(new Vector2d(-58.0, 12), Math.toRadians(180.00))
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-36.00, 11), Math.toRadians(0.00))
                .splineToConstantHeading(new Vector2d(24, 11.0), Math.toRadians(0.00))
                .splineToSplineHeading(new Pose2d(48, 32.0, Math.toRadians(180)),Math.toRadians(0.00))
//                .splineToConstantHeading(new Vector2d(48, 30.0), Math.toRadians(0.00))

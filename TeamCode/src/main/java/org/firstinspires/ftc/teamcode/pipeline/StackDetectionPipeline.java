...
public class StackDetectionPipeline implements VisionProcessor, CameraStreamSource {

    public static int TOPLEFT_X = 900;
    public static int TOPLEFT_Y = 200;
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        Imgproc.circle(frame2, new Point(closestPixelContour.x, closestPixelContour.y), 7, new Scalar(0, 0, 255), 5);
...
//        Log.d("StackDetection_logger", "TAPE POSE: (" + closestTapeContour.x + ", " + closestTapeContour.y + ")");
        ...
        Rect newRect = new Rect(TOPLEFT_X, TOPLEFT_Y , WIDTH, HEIGHT);
        Imgproc.rectangle(frame, newRect, new Scalar(255, 0, 0), 5);
...
//        correctionAmt = -0.0120*closestTapeContour.x + 12.42;
    ...
    public class ContourData {
        ...
        public String toString() {
            return "(x,y): " + "(" + x + "," + y + ")"
                    + " | area: " + String.format("%3.2f", area)
                    + " | length: " + String.format("%3.2f", length);
        }
    }
}
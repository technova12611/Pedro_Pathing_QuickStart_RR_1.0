...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        ...
        public double parYTicks = 0; // 11110.24332364755; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 0; //-9980.239241262898; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick) {
        ...
        perp = new OverflowEncoder(new RawEncoder(HardwareCreator.createMotor(hardwareMap, "perp")));

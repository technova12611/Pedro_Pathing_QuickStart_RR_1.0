...
@Config
public class ContourDetectionPipeline implements VisionProcessor, CameraStreamSource {
...
//     public static Scalar scalarUpperYCrCb = new Scalar(255.0, 120.0, 120.0);
    ...
    public ContourDetectionPipeline() {
        this.borderLeftX = 1;
        this.borderRightX = 1;
        this.borderTopY = 1;
        this.borderBottomY = 1;
    }
 ...
 //           Imgproc.GaussianBlur(processed, processed, new Size(5.0, 15.0), 0.00);
            Imgproc.blur(processed, processed, new Size(50.0, 50.0));
            // Find Contours
            ...
            synchronized (sync) {
                ...
                for (MatOfPoint contour : contours) {
                    ...
                    if (contourArray.length >= 15) {
                        ...
                        if (                        rect.area() > maxArea || contourNumber == 1
...
//                                && rect.y + (rect.height / 2.0) < CAMERA_HEIGHT - (borderBottomY * CAMERA_HEIGHT)
            ...
            if (first && maxRect.area() > 2000) {
                Imgproc.rectangle(input, maxRect, new Scalar(255, 0, 0), 2);
            }
            // Draw Borders

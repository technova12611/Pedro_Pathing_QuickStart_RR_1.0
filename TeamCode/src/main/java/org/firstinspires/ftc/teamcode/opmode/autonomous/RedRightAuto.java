...
public class RedRightAuto extends NearAutoBase {
   ...
   public static Pose2d[] red_backdrop =  {
           new Pose2d(48.0, -31.0, Math.toRadians(180)), // 29.5 for left
           new Pose2d(48.0, -38.0, Math.toRadians(180)),  // 35.0 for center
           new Pose2d(48.0, -43.6, Math.toRadians(180))  // 41 for right
   };
   // 0 = left, 1 = middle, 2 = right

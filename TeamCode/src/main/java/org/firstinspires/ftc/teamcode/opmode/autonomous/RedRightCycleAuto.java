...
public class RedRightCycleAuto extends NearCycleAutoBase {
    ...
    protected void onInit() {
        ...
        this.stackIntake1 = new Pose2d(-57.5, -12.0, Math.toRadians(180));
        this.stackIntake2 = new Pose2d(-58.5, -11.0, Math.toRadians(180));
        ...
        cycleScore = new Pose2d[] {
                new Pose2d(47.8, -35.5, Math.toRadians(180)),
